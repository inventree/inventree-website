...
[Translations](/contribute#translate) for the InvenTree project continue to grow, thanks to our vibrant community of users. Thanks to the [crowdin project](https://crowdin.com) which makes this possible.
...
<Thumbnail src="/img/blog/world-map.png" title="World map" />
