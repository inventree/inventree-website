...
<Thumbnail src="/img/blog/select-labels.png" title="Select items" />

**Label Printing Dialog**

Select the *InvenTree Sheet Label Printer* plugin:

<Thumbnail title="Select printer" src="/img/blog/printer-dialog.png" />
...
<Thumbnail title="Print labels" src="/img/blog/print-labels.png" />
