...
The new interface is enabled by default, and can be accessed by navigating to `/platform/` on your InvenTree installation. You can see it live at [https://demo.inventree.com/platform/](https://demo.inventree.com/platform/). If you encounter any issues with the new interface, please report them on our github page!
