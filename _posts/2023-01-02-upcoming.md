...
If you have found InvenTree to be a useful piece of software, especially if you are using it for your business, please consider [sponsoring the project](fund.md#github/). Sponsorship allows the developers to provide more of their (quite precious) time to the project, which benefits everyone.
