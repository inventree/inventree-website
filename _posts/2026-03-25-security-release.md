...
The InvenTree core development team has received a report of a *critical security vulnerability*  affecting a large range of releases since 2024. We will release a disclosure and a fixed release for the 1.2.x release series on yyyy-mm-dd.  
...
- Ensure registration is disabled, and that all users have strong passwords
