...
| Option | Description |
| --- | --- |
| [Server](/app/connect.md) | Select server profile and configure settings |
...
The *Barcode Settings* view allows you to configure options relating to [barcode scanning](/app/barcode.md):
