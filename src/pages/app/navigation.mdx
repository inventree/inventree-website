...
The *search* action opens the [Search](./search.md) screen

### Scan Barcode

The *barcode* action opens the [barcode scan](./barcode.md#global-scan) window, which allows quick access to the barcode scanning functionality.
