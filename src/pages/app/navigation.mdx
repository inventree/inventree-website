...
The *search* action opens the [Search](/app/search.md) screen

### Scan Barcode

The *barcode* action opens the [barcode scan](/app/barcode.md#global-scan) window, which allows quick access to the barcode scanning functionality.
