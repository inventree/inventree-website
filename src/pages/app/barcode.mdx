...
From the [Stock Location detail page](/app/stock.md#stock-location-view), multiple barcode actions may be available:
...
From the [Stock Item detail page](/app/stock.md#stock-item-detail-view), the following barcode actions may be available:
...
From the [Part detail page](/app/part.md#part-detail-view), the following barcode actions are available:
...
From the [Purchase Order detail page](/app/po.md#purchase-order-detail) page, the following barcode actions are available:
